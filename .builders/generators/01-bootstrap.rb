  ...
  action do
    ...
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Tailwind DSL will build tailwind websites useing Domain Specific Language conventions',
        application_lib_path:       application_name.to_s,
        application_lib_namespace:  'TailwindDsl',
        namespaces:                 ['TailwindDsl'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 'As a Developer, I can use natural language systems to build websites quickly, so that I can automate website creation',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/tailwind_dsl'
      )
      .github(
        active: false,
...
KManager.opts.app_name                    = 'tailwind_dsl'
