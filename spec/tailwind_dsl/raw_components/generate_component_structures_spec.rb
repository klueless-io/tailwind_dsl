...
#   source: {
#     file:           file[:absolute_file],
#     exists:         File.exist?(file[:absolute_file]),
#     content:        File.exist?(file[:absolute_file]) ? File.read(file[:absolute_file]) : ''
#   },
#   target: {
#     settings_file:  file[:other_files][:settings],
#     data_file:      file[:other_files][:data],
#     astro_file:     file[:other_files][:astro]
#   }
# }

RSpec.describe TailwindDsl::RawComponents::GenerateComponentStructures do
